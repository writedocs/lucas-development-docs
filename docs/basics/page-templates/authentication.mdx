...
The [your-company] API uses the ApiKey security schema to authenticate HTTP requests. API keys are alphanumeric credentials that authorize access to specific features within our API.a
